...
const FeaturesSection = () => {
  const features = [
    ...
    {
      icon: "💎",
      title: "Extensions Durables", 
      description: "Ongles qui tiennent longtemps avec une brillance impeccable"
    },
    {
      icon: "💄",
      title: "Maquillage Pro",
      description: "Techniques professionnelles pour un rendu naturel ou glamour"
    }
  ]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Comment nous sublimez votre beauté
        </motion.h2>
        <motion.p 
          variants={fadeIn('up', 0.4)}
          className="text-gray-600"
        >
          Des services professionnels et personnalisés juste pour vous
        </motion.p>
      </motion.div>
